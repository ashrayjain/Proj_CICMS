...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(169, 26);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Specify sale of of products: please\ninput a number";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(28, 89);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(109, 89);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(55, 56);
