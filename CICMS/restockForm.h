...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Restock: please input a number";
			// 
			// button1
			// 
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(109, 84);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(53, 51);
